...
class pascalVOCLoader_reduced(data.Dataset):
    ...
    def decode_segmap(self, label_mask, plot=False):
        ...
        g = label_mask.copy()
        b = label_mask.copy()
        for ll in range(0, self.n_classes+1):
    ...
    def setup_annotations(self):
        ...
        if len(pre_encoded) != expected:
            ...
            print("Pre-encoding trainval (VOC) segmentation masks...")
        ...
        print('expected number of files: ',expected)
